  ...
  return (
    <div className="flex h-full bg-surface overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Action Bar */}
        <footer className="p-4 sm:p-6 border-t border-outline/10 bg-surface/80 backdrop-blur-md">
      ...
      <aside className="w-[320px] bg-surface-container-low border-l border-outline/10 flex flex-col animate-in slide-in-from-right duration-1000">
        ...
        <div className="p-4 sm:p-6 bg-on-surface/[0.02] border-t border-outline/10">
      ...
      <AnimatePresence>
        {intelligenceModal?.isOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-8 bg-black/40 backdrop-blur-sm">
            ...
            >
              <div className="p-4 sm:p-6 border-b border-outline/10 flex items-center justify-between bg-surface-container-low">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-primary/5 rounded-xl">
              ...
              <div className="p-4 sm:p-6 bg-surface-container-low border-t border-outline/10 flex justify-end">
                <button 
