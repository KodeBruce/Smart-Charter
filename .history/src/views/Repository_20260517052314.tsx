...
export default function Repository() {
  ...
  return (
    <div className="flex flex-col h-full bg-surface overflow-hidden">
      <div className="px-8 py-3 border-b border-outline/5 flex items-center justify-between bg-surface-container-lowest/30">
        <div className="text-sm font-bold">Repository Header (temporarily simplified)</div>
      </div>
