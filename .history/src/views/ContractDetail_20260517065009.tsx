                  ...
                  <div className="flex-1 overflow-y-auto no-scrollbar">
                    {(analysis.keyClauses || [])
                      ...
                      <button 
                        ...
                        className={`w-full text-left px-8 py-6 transition-all border-b border-outline/10 group relative ${
      ...
      <AnimatePresence>
        {intelligenceModal && intelligenceModal.isOpen && (
          ...
          >
            ...
            >
              <div className="p-4 sm:p-6 pb-6 border-b border-outline/10 flex items-start justify-between bg-surface-container-low/50">
                <div>
              ...
              <div className="p-4 sm:p-6 min-h-[200px] max-h-[60vh] overflow-y-auto custom-scrollbar">
                {!intelligenceModal.explanation ? (
                  ...
                  <div className="space-y-8">
                    ...
                    {intelligenceModal.optimizedRawText && intelligenceModal.optimizedRawText !== analysis.rawText && (
                      <div className="pt-8 border-t border-outline/10 flex flex-col gap-6">
                        ...
                        {showDiffInModal && (
                           <div className="p-4 sm:p-6 bg-surface-container-low border border-outline/20 rounded-[24px] max-h-[350px] overflow-y-auto custom-scrollbar space-y-4">
