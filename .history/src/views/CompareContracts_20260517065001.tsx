  ...
  return (
    <div className="flex flex-1 h-full overflow-hidden bg-surface">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Content Area */}
        <main className="flex-1 overflow-auto custom-scrollbar p-4 sm:p-6">
          {selectedContracts.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center space-y-6">
              <div className="w-20 h-20 bg-surface-container rounded-xl sm:rounded-[32px] flex items-center justify-center">
