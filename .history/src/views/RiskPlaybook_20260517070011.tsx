        ...
        <section id="walkthrough-risk-view" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredPlaybooks.map((playbook, i) => (
            <motion.div
              ...
              className="bg-surface-container-low border border-outline rounded-[24px] p-6 flex flex-col justify-between hover:shadow-xl hover:shadow-black/5 transition-all group cursor-pointer"
            >
              <div className="mb-6">
        ...
        <section className="p-8 bg-[#0D0D0D] rounded-[40px] text-white border border-white/5 relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-4">
              <button 
                onClick={() => setIsAiModalOpen(true)}
                className="px-4 py-2 sm:px-6 sm:py-3 bg-primary text-on-primary text-[11px] font-extrabold uppercase tracking-widest rounded-xl hover:scale-105 active:scale-95 transition-all shadow-xl shadow-primary/20 flex items-center gap-2"
              >
              ...
              <button 
                ...
                className="px-4 py-2 sm:px-6 sm:py-3 bg-white/5 border border-white/10 text-white text-[11px] font-extrabold uppercase tracking-widest rounded-xl hover:bg-white/10 transition-all font-bold"
              >
                Create Manually
              </button>
            </div>
