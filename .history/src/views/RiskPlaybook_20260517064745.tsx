        ...
        {isAiModalOpen && (
          <>
            ...
            <motion.div 
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[500px] bg-surface rounded-xl sm:rounded-[32px] p-4 sm:p-6 z-[70] shadow-sm sm:shadow-2xl border border-outline overflow-hidden"
            >
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar p-4 sm:p-8 space-y-8">
                ...
                {(isEditing ? editForm?.jurisdictionalAlert : selectedPlaybook.jurisdictionalAlert) && (
                  <section className="p-4 sm:p-5 bg-error/[0.03] border border-error/10 rounded-xl sm:rounded-[32px] flex gap-4 items-start relative overflow-hidden">
