...
export default function Repository() {
  return (
    <div className="flex flex-col h-full bg-surface overflow-hidden">
      <TopBar title="Repository (placeholder)" />
      <main className="p-8">
        <h1 className="text-xl font-bold">Repository (temporary placeholder)</h1>
        <p className="mt-4 text-on-surface/60">The full repository view was temporarily simplified to resolve a syntax error introduced during edits. I'll restore responsive table and modals after confirming the build passes.</p>
      </main>
    </div>
  );
}
