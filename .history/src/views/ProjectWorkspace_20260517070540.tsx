          ...
          <AnimatePresence mode="wait">
                        ...
                        <div className="p-6 border-t border-outline flex items-center justify-between gap-3 bg-surface">
                          <div className="flex items-center gap-3">
                            ...
                            <button 
                              ...
                              className="px-4 py-2 sm:px-6 sm:py-2 bg-primary text-on-primary text-[10px] font-bold uppercase tracking-widest rounded-xl shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
                            >
                              Save Changes
                            </button>
                          </div>
                ...
                {isCreateModalOpen && (
                  <>
                    ...
                    <motion.div 
                      ...
                      className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[400px] bg-surface rounded-xl p-6 sm:p-8 z-[90] shadow-2xl border border-outline"
                    >
            ...
            {activeTab === 'drafting' && (
              ...
              >
                ...
                <div className="bg-surface-container-low border border-outline rounded-xl p-6 shadow-sm">
                ...
                {draftResult && (
                  <motion.div 
                    ...
                    className="space-y-6"
                  >
                    <div className="p-6 bg-surface dark:bg-surface-container-high border border-outline dark:border-outline/20 rounded-xl shadow-sm font-serif italic text-sm text-primary dark:text-primary-light leading-relaxed whitespace-pre-wrap">
                      {draftResult}
                    </div>
                    <div className="flex gap-4">
                      ...
                      <button 
                        ...
                        className="px-4 py-3 sm:px-6 sm:py-3 bg-surface border border-outline rounded-2xl text-[11px] font-extrabold uppercase tracking-widest"
                      >
                        Discard
                      </button>
                    </div>
