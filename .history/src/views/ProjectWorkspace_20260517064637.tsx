  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Content */}
        <main className="flex-1 overflow-y-auto custom-scrollbar bg-surface p-4 sm:p-6">
              ...
              >
                ...
                {draftResult && (
                  <motion.div 
                    ...
                    className="space-y-6"
                  >
                    <div className="p-4 sm:p-6 bg-surface dark:bg-surface-container-high border border-outline dark:border-outline/20 rounded-xl sm:rounded-[32px] shadow-sm font-serif italic text-sm text-primary dark:text-primary-light leading-relaxed whitespace-pre-wrap">
                      {draftResult}
                    </div>
              ...
              <>
                ...
                >
                  ...
                  <div className="space-y-8">
                     ...
                     <div className="space-y-6">
                        <div className="p-4 sm:p-6 bg-surface-container-lowest border-2 border-dashed border-outline rounded-xl sm:rounded-[32px] flex flex-col items-center justify-center gap-4 group hover:border-primary/40 transition-all cursor-text" onClick={() => document.getElementById('sig-input')?.focus()}>
