...
export default function SpeechmaticsAssistant() {
  ...
  return (
    <div ref={containerRef} style={wrapperStyle} className="fixed z-[60] pointer-events-auto max-w-[92vw]">
      <AnimatePresence>
        {isListening && (
          <motion.div
          ...
          >
              ...
              <div onPointerDown={onPointerDown} style={{ touchAction: 'none', cursor: 'grab' }}>
