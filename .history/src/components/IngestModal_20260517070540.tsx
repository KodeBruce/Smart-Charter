      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-1rem)] sm:w-full sm:max-w-md bg-surface border border-outline rounded-[24px] sm:rounded-[32px] p-4 sm:p-8 z-[101] shadow-2xl overflow-auto max-h-[calc(100vh-5rem)]"
          >
