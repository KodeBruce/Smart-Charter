      ...
      <nav className="fixed bottom-4 left-1/2 -translate-x-1/2 md:hidden w-[92%] max-w-lg bg-surface/95 backdrop-blur rounded-full border border-outline px-2 py-1 flex items-center justify-between gap-2 z-50 shadow-lg">
        ...
        {mobileExtrasOpen && (
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[86%] max-w-sm bg-surface-container border border-outline rounded-2xl p-3 flex items-center justify-around gap-3 shadow-xl pointer-events-auto"
          >
            <button
              onClick={toggleVoice}
