...
export default function VoiceController() {
  ...
  const statusLabel = isListening ? 'Listening' : recognitionError ? 'Mic Error' : 'Mic Idle';
        ...
        >
            ...
            <div className="flex justify-between items-center pb-3 border-b border-white/10">
              <div className="flex items-center gap-3">
                <div className="relative">
                  <div className={`absolute inset-0 rounded-full animate-ping ${isListening ? 'bg-[#E2FF6F]/20' : 'bg-white/10'}`} />
                  <div className={`relative w-2.5 h-2.5 rounded-full ${isListening ? 'bg-[#E2FF6F]' : recognitionError ? 'bg-red-400' : 'bg-white/30'}`} />
                </div>
                <div>
                  <h4 className="text-[10px] font-black uppercase tracking-[0.25em] text-[#E2FF6F]">Vocal Sentinel</h4>
                  <p className="text-[8px] font-bold text-white/40 uppercase tracking-widest mt-0.5">{statusLabel}</p>
                </div>
              </div>
            ...
            <div className="min-h-[22px] flex items-center justify-center bg-white/[0.03] border border-white/5 rounded-xl py-1 px-3">
              {showFeedback && lastCommand ? (
                ...
                <p className="text-[9px] font-bold text-red-300 uppercase tracking-wider truncate">
                  Mic error: {recognitionError}
                </p>
              ) : (
