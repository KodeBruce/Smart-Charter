    ...
    >
      ...
      {!isListening && (
        <button
          ...
          className="pointer-events-auto inline-flex items-center gap-2 rounded-full border border-outline/30 bg-surface/95 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.22em] text-on-surface/70 shadow-lg shadow-black/10 hover:bg-surface transition-colors"
