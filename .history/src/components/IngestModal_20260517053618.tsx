      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 right-0 sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 bottom-0 sm:bottom-auto w-full sm:max-w-md bg-surface border border-outline rounded-t-2xl sm:rounded-[32px] p-4 sm:p-8 z-[101] shadow-2xl overflow-auto max-h-[90vh]"
          >
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-primary tracking-tight leading-none flex items-center gap-2">
            ...
            {isUploading ? (
              <div className="py-8 sm:py-12 flex flex-col items-center gap-6">
                ...
                <div className="text-center space-y-3 w-full">
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      className="space-y-1"
                    >
                      <p className="text-on-surface text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.15em] italic">
                        {LOADING_STAGES[loadingStage].label}
                      </p>
                      <p className="text-on-surface-variant/50 text-[9px] sm:text-[9px] font-medium uppercase tracking-widest leading-relaxed max-w-[280px] mx-auto">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div
                    ...
                    className="border-2 border-dashed border-white/10 rounded-2xl p-4 sm:p-8 flex flex-col items-center gap-3 sm:gap-4 hover:border-[#E2FF6F]/30 hover:bg-[#E2FF6F]/5 transition-all cursor-pointer group"
                  >
                    <div className="p-3 sm:p-4 bg-white/5 rounded-2xl group-hover:bg-[#E2FF6F] group-hover:text-black transition-all">
